...
dados = pd.read_csv("16x16_packets_train.csv")
...
plt.title("Mapping by Delivered Packets - 16x16")
plt.ylabel("Delivered Packets (Log Scale)")
...
plt.savefig("packets_16x16.png")

saida = open('result_packets_16x16.txt', 'w')
